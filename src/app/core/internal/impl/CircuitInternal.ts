import {AddErrE, MultiError} from "core/utils/MultiError";
...
import {ComponentInfo, ObjInfo, PortConfig}              from "./ComponentInfo";
...
export class CircuitInternal extends Observable<FastCircuitDiff> implements ReadonlyCircuitDocument {
    private readonly mutableDoc: CircuitDocument;
    // TODO: Remove "implements" above in favor of accessing "doc"
    ...
    //
    // Forwards to CircuitDocument
    //
    // TODO: remove in favor of direct "doc" access
    public getObjectInfo(kind: string): ObjInfo { return this.doc.getObjectInfo(kind); }
    public getComponentInfo(kind: string): ComponentInfo { return this.doc.getComponentInfo(kind); }
    public getObjectAndInfoByID(id: string): Result<[Readonly<Schema.Obj>, ObjInfo], MultiError> {
        return this.doc.getObjectAndInfoByID(id);
    }
    public getComponentAndInfoByID(id: string): Result<[Readonly<Schema.Component>, ComponentInfo], MultiError> {
        return this.doc.getComponentAndInfoByID(id);
    }
    public hasComp(id: string): boolean { return this.doc.hasComp(id); }
    public hasWire(id: string): boolean { return this.doc.hasWire(id); }
    public hasPort(id: string): boolean { return this.doc.hasPort(id); }
    public getObjByID(id: string): Result<Readonly<Schema.Obj>, MultiError> { return this.doc.getObjByID(id); }
    public getCompByID(id: string): Result<Readonly<Schema.Component>, MultiError> { return this.doc.getCompByID(id); }
    public getWireByID(id: string): Result<Readonly<Schema.Wire>, MultiError> { return this.doc.getWireByID(id); }
    public getPortByID(id: string): Result<Readonly<Schema.Port>, MultiError> { return this.doc.getPortByID(id); }
    public getObjs(): IterableIterator<string> { return this.doc.getObjs(); }
    public getPortsForComponent(id: string): Result<ReadonlySet<string>, MultiError> {
        return this.doc.getPortsForComponent(id);
    }
    public getPortsForWire(id: string): Result<readonly [string, string], MultiError> {
        return this.doc.getPortsForWire(id);
    }
    public getWiresForPort(id: string): Result<ReadonlySet<string>, MultiError> { return this.doc.getWiresForPort(id); }
    public getPortConfig(id: string): Result<PortConfig, MultiError> { return this.doc.getPortConfig(id); }
}
