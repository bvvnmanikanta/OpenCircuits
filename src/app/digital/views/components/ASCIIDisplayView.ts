...
import {ASCIIDisplay} from "core/models/types/digital";
...
// TODO allow for changing of segment count
export class ASCIIDisplayView extends ComponentView<ASCIIDisplay, DigitalViewInfo> {
    public constructor(info: DigitalViewInfo, obj: ASCIIDisplay) {
        super(info, obj);
    }
    ...
    protected override renderComponent({ renderer, selections }: RenderInfo): void {
		...
		const font = ASCIIFont[`${segmentCount}`];
    ...
    protected getSegments(segmentCount: number): Array<[Vector, string]> {
